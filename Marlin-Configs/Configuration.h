...
#define STRING_CONFIG_H_AUTHOR "(Benjamin Faure SKR 1.3 CFG)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ben's SKR 1.3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 280.6 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 900, 900, 40, 50 }
